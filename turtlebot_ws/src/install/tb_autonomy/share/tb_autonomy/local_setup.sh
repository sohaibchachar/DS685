...
: ${AMENT_CURRENT_PREFIX:="/workspaces/eng-ai-agents/turtlebot_ws/src/install/tb_autonomy"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tb_autonomy/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tb_autonomy/environment/path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tb_autonomy/environment/pythonpath.sh"
